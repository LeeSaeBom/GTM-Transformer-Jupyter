...
class ImageEmbedder(nn.Module):
    def __init__(self):
        ...
        # 또는 초기 레이어들만 freeze하고 나머지는 학습 가능하게 설정
        # for i, c in enumerate(self.resnet.children()):
        #     if i < 5:  # 처음 5개 레이어만 freeze
...
class GTM(pl.LightningModule):
    ...
    def training_step(self, train_batch, batch_idx):
        ...
        # 입력 텐서들의 gradient 활성화 (데이터로더에서 나온 텐서는 기본적으로 requires_grad=False)
